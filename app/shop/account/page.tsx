...
const menuItems = [
    {
        section: 'Pesanan',
        items: [
            { icon: Package, label: 'Pesanan Saya', href: '/shop/orders', badge: '2' },
            { icon: ShoppingBag, label: 'Beli Lagi', href: '/shop/reorder' },
        ]
    },
    {
        section: 'Akun',
    ...
    return (
        <>
            ...
            <div className="px-4 py-6 flex flex-col gap-6 pb-24">
                ...
                {/* Logout Button */}
                <button className="flex items-center gap-4 px-4 py-4 bg-white rounded-2xl shadow-sm border border-red-100 hover:bg-red-50 transition-colors">
