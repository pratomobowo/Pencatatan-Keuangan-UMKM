  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full">
      ...
      <div className="lg:col-span-4 flex flex-col gap-6">
        <Card title="Database Komponen Modal" className="h-full">
          <p className="text-xs text-slate-500 mb-4">
            Simpan data kemasan, bumbu, atau biaya per-unit di sini agar mudah digunakan berulang kali.
          </p>
          ...
          <form onSubmit={handleAddComponent} className="bg-slate-50 p-3 rounded-lg border border-slate-200 mb-4">
            <div className="space-y-3">
              ...
              <button type="submit" className="w-full py-2 bg-slate-800 text-white text-xs font-medium rounded hover:bg-slate-700 flex items-center justify-center gap-1">
                <Plus size={14} /> Simpan Komponen
              </button>
            </div>
          </form>
      ...
      <div className="lg:col-span-8 flex flex-col gap-6">
        <Card className="h-full bg-slate-50/50">
          <div className="flex items-center gap-2 mb-6 border-b border-slate-200 pb-4">
            ...
            <h2 className="text-lg font-semibold text-slate-800">Perakitan Harga Modal (HPP)</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
                <h3 className="text-xs font-medium text-slate-400 uppercase mb-3 flex items-center gap-2">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full mt-1 p-2 border border-slate-300 rounded text-sm font-medium"
                ...
                <div className="space-y-3">
                  ...
                  {result.shrinkageCost > 0 && (
                    <p className="text-xs text-rose-600 bg-rose-50 p-2 rounded">
                      *Biaya naik <strong>{formatCurrency(result.shrinkageCost)}</strong> akibat penyusutan.
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="flex flex-col h-full">
                      ...
                      <div key={idx} className="flex justify-between items-center bg-slate-50 p-2 rounded border border-slate-100 text-sm">
                        ...
                        <div className="flex items-center gap-3">
                          <input
                            type="number"
                            min="1"
                            className="w-12 p-1 text-center border border-slate-300 rounded text-xs"
                            value={item.qty}
              ...
              <div className="bg-slate-900 text-white p-5 rounded-xl shadow-lg">
                ...
                <div className="pt-4 border-t border-slate-700">
                  ...
                  <h1 className="text-center text-3xl font-bold text-blue-400">{formatCurrency(result.roundedPrice)}</h1>
                </div>
