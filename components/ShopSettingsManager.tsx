...
type TabId = 'store' | 'contact' | 'shipping' | 'payment' | 'hours' | 'faq' | 'popup';
    ...
    return (
        <div className="space-y-6 pb-12">
            ...
            <div className="mt-6">
                ...
                {activeTab === 'popup' && (
                    <PopupTab config={config} setConfig={setConfig} />
                )}
            </div>
        </div>
    );
...
// Tab 7: Marketing Popup
const PopupTab = ({ config, setConfig }: { config: ShopConfigState; setConfig: React.Dispatch<React.SetStateAction<ShopConfigState>> }) => {
